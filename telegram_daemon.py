...
async def cmd_week(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # FIX: Use correct column names (realized_equity/agent_decision_calls don't exist)
    rows = _query_db("SELECT date, gross_pnl, total_trades FROM daily_stats WHERE date >= ? ORDER BY date ASC", (start_of_week.isoformat(),))
