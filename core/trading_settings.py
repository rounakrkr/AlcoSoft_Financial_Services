...
FIELD_SCHEMA: list[dict] = [
    ...
    {"section": "strategy", "key": "min_strategies_agree", "label": "AI: min strategies for BUY", "type": "int", "min": 1, "max": 6, "step": 1, "hint": "Minimum cognitive strategies that must agree to trigger a BUY."},
    {"section": "strategy", "key": "math_strategies_agree", "label": "Math: min strategies for BUY", "type": "int", "min": 1, "max": 6, "step": 1, "hint": "Minimum math/technical signals required to place a BUY."},
    {"section": "strategy", "key": "min_sell_signals", "label": "Min sell signals to exit", "type": "int", "min": 1, "max": 4, "step": 1, "hint": "Number of sell/exit signals required to close a position."},
