...
FIELD_SCHEMA: list[dict] = [
    ...
    {"section": "risk", "key": "max_risk_per_trade", "label": "War room risk / trade (%)", "type": "percent", "min": 0.5, "max": 10, "step": 0.5},
    {"section": "risk", "key": "math_risk_per_trade", "label": "Math watchlist risk / trade (%)", "type": "percent", "min": 0.5, "max": 10, "step": 0.5},
    {"section": "risk", "key": "max_daily_loss_percent", "label": "Max daily loss (%)", "type": "percent", "min": 1, "max": 20, "step": 0.5},
    {"section": "risk", "key": "paper_capital", "label": "Paper capital (₹)", "type": "int", "min": 1000, "max": 10000000, "step": 1000},
    {"section": "strategy", "key": "max_open_positions", "label": "Max open positions", "type": "int", "min": 1, "max": 10, "step": 1},
    {"section": "strategy", "key": "min_confidence", "label": "Min war room confidence", "type": "int", "min": 0, "max": 100, "step": 5},
    {"section": "strategy", "key": "min_strategies_agree", "label": "War room: min strategies for BUY", "type": "int", "min": 1, "max": 6, "step": 1},
    {"section": "strategy", "key": "math_strategies_agree", "label": "Math: min strategies for BUY", "type": "int", "min": 1, "max": 6, "step": 1},
    {"section": "strategy", "key": "min_sell_signals", "label": "Min sell signals to exit", "type": "int", "min": 1, "max": 4, "step": 1},
    ...
    {"section": "strategy", "key": "min_ws_candles_for_patterns", "label": "Min live WS candles (patterns)", "type": "int", "min": 1, "max": 10, "step": 1},
    {"section": "strategy", "key": "war_room_gating", "label": "War room gating (BUY_ONLY only)", "type": "bool"},
    {"section": "strategy", "key": "loop_interval_sec", "label": "Strategy loop interval (sec)", "type": "int", "min": 1, "max": 60, "step": 1},
    {"section": "screener", "key": "screener_total_stocks", "label": "Screener: total stocks", "type": "int", "min": 5, "max": 50, "step": 1},
    {"section": "screener", "key": "war_room_picks", "label": "Screener: war room picks", "type": "int", "min": 1, "max": 10, "step": 1},
    ...
    {"section": "market_data", "key": "health_min_ws_candles", "label": "Health check: min WS candles", "type": "int", "min": 1, "max": 30, "step": 1},
    {"section": "market_data", "key": "scan_log_interval_sec", "label": "Full scan log interval (sec)", "type": "int", "min": 30, "max": 600, "step": 10},
    {"section": "scheduling", "key": "war_room_interval_minutes", "label": "War room interval (min)", "type": "int", "min": 5, "max": 120, "step": 5},
]
